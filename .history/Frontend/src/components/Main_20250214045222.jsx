...
export default function MainPage() {
  ...
  return (
    <div className="bg-[#FFFBE9] min-h-screen text-[#5D4037]">
      {/* Navbar */}
      <nav className="bg-[#AD8B73] py-4 px-6 flex justify-between items-center shadow-md">
        <h1 className="text-4xl font-extrabold text-white tracking-wide">BuyYours</h1>
      </nav>

      {/* Hero Section */}
      <section className="flex flex-col items-center text-center py-16 bg-[#CEAB93] text-white">
        <h2 className="text-6xl font-extrabold mb-6">New Arrivals</h2>
        <button
          className="bg-[#AD8B73] px-8 py-3 text-white font-bold rounded-lg shadow-lg hover:scale-105 hover:bg-[#8B5E3C] transition"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-8">
        {[image1, image2, image3, image4].map((image, index) => (
          <div
            key={index}
            className="bg-[#E3CAA5] p-6 text-center rounded-lg shadow-lg h-80 transition-transform transform hover:scale-105"
          >
      ...
      {/* Subscribe Section */}
      <section className="bg-[#CEAB93] text-center py-12 text-white">
        ...
        <div className="flex justify-center">
          <input
            ...
            className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#AD8B73] outline-none"
          />
          <button className="ml-4 bg-[#AD8B73] px-6 py-3 text-white font-bold rounded-lg shadow-md hover:scale-105 hover:bg-[#8B5E3C] transition">
            Subscribe
          </button>
        </div>
      </section>
      ...
      <section className="p-8">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {[
            ...
            <div
              key={index}
              className="bg-[#E3CAA5] p-5 rounded-lg shadow-md w-80 text-center hover:shadow-xl transition-shadow"
            >
      ...
      {/* Footer */}
      <footer className="bg-[#CEAB93] text-center py-6 text-white font-bold text-lg">
