      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        {categories.map((category) => (
          <div 
            ...
            className="relative bg-[#EBE3D5] rounded-lg shadow-md overflow-hidden"
          >
            {/* Category Name Overlay */}
            <div className="absolute inset-x-0 top-0 bg-black bg-opacity-50 text-white text-lg font-semibold p-2 text-center">
