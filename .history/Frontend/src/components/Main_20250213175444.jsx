...
export default function MainPage() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen text-gray-800">
      ...
      {/* Hero Section */}
      <section className="flex flex-col items-center text-center py-16 bg-violet-500 text-white bg-gradient-to-r from-black to-purple-900 min-h-screen text-gray-200">
