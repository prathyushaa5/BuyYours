...
export default function MainPage() {
  ...
  return (
    <div className="bg-[#F5F5DC] min-h-screen text-[#5D4037]">
      {/* Navbar */}
      <nav className="bg-[#D2B48C] py-4 px-6 flex justify-between items-center shadow-md">
        <h1 className="text-4xl font-extrabold text-white tracking-wide">BuyYours</h1>
      </nav>

      {/* Hero Section */}
      <section className="flex flex-col items-center text-center py-16 bg-[#D2B48C] text-white">
        <h2 className="text-6xl font-extrabold mb-6">New Arrivals</h2>
        <button
          className="bg-[#A67B5B] px-8 py-3 text-white font-bold rounded-lg shadow-lg hover:scale-105 hover:bg-[#8B5E3C] transition"
      ...
      {/* Subscribe Section */}
      <section className="bg-[#D2B48C] text-center py-12 text-white">
        ...
        <div className="flex justify-center">
          <input
            ...
            className="px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#A67B5B] outline-none"
          />
          <button className="ml-4 bg-[#A67B5B] px-6 py-3 text-white font-bold rounded-lg shadow-md hover:scale-105 hover:bg-[#8B5E3C] transition">
            Subscribe
          </button>
        </div>
      </section>
      ...
      {/* Footer */}
      <footer className="bg-[#D2B48C] text-center py-6 text-white font-bold text-lg">
