  ...
  return (
    <div className="min-h-screen p-6 bg-gray-100">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md max-w-md mx-auto mb-6">
        ...
        <textarea name="description" placeholder="Description" value={newProduct.description} onChange={handleInputChange} className="w-full p-2 border mb-2 rounded" />
        ...
        <input type="number" name="categoryID" placeholder="Category ID" value={newProduct.categoryID} onChange={handleInputChange} className="w-full p-2 border mb-2 rounded" />
      ...
      {editingProduct && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <textarea name="description" value={editingProduct.description} onChange={handleEditInputChange} className="w-full p-2 border mb-2 rounded" />
            ...
            <input type="number" name="categoryID" value={editingProduct.categoryID} onChange={handleEditInputChange} className="w-full p-2 border mb-2 rounded" />
