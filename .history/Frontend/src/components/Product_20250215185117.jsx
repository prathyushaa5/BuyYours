      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {products.map((product) => (
          ...
          >
            ...
            <button
          className="bg-red-900 mt-2  px-6 py-2 text-white font-bold rounded-lg shadow-lg hover:scale-105 hover:bg-[#776B5D] transition"
         
        >
          Buy Now
        </button>
        <button
          className="bg-blue-900  mt-2  px-6 py-2  text-white font-bold rounded-lg shadow-lg hover:scale-105 hover:bg-[#776B5D] transition"
